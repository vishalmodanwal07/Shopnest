...
function Signup() {
  ...
  //        </div>
  //      </div>
  //      <div className=" ml-10 p-1 flex justify-center items-center  border-b-4 w-[30%] border-gray-300 rounded-lg  mb-6 shadow-[rgba(7,_65,_210,_0.1)_0px_9px_30px] hover:shadow-[5px_5px_0px_0px_rgba(109,40,217)] hover:scale-110 transition duration-300 ease-in  " style={{ fontFamily: '"Raleway", sans-serif' }} >
  ...
  //         <div className="mb-2 flex justify-center items-center  bg-white dark:bg-gray-800 text-black dark:text-white" style={{ fontFamily: '"Raleway", sans-serif' }}>
  //         </div>
...
<div className="flex items-center justify-center px-4  sm:px-6 sm:py-16 lg:px-8 lg:py-10  bg-white dark:bg-gray-800 text-black dark:text-white " style={{ fontFamily: '"Raleway", sans-serif' }}>
 <div className="xl:mx-auto xl:w-full xl:max-w-sm 2xl:max-w-md  bg-white dark:bg-gray-800 text-black dark:text-white border-gray-300 rounded-lg p-8 mb-6 shadow-[rgba(7,_65,_210,_0.1)_0px_9px_30px] hover:shadow-[5px_5px_0px_0px_rgba(109,40,217)] hover:scale-110 transition duration-300 ease-in " style={{ fontFamily: '"Raleway", sans-serif' }}>
